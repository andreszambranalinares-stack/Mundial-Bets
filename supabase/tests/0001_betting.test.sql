...
select throws_ok($$
  select public.place_combo_bet('33333333-3333-3333-3333-333333333333', 50,
    '[{"match_id":"m1","market":"h2h","selection":"home","point":0},
      {"match_id":"m1","market":"totals","selection":"over","point":2.5}]'::jsonb)
$$, null, 'Rechaza combinar dos selecciones del mismo partido');
